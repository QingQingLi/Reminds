...
//    self.titleArr = [NSArray arrayWithObjects:@[@"闹钟开关"],@[@"闹钟定时",@"震动",@"铃声"],@[@"周期"],nil];
//    self.bellStr = @"吉他";
    
//    [self getData];
//    
//    if (self.clockTime.length <=0) {
//        self.clockTime = [[YMClockManager shareManager] getCurrentTime];
//    }
}
...
//- (NSString *)getClockTimeStrWithRemindStr:(NSString *)rStr{
//
//    NSArray *arr = [rStr componentsSeparatedByString:@":"];
//    NSMutableString *mStr = [NSMutableString string];
//    if ([arr[0] integerValue] < 12) {
//        [mStr appendFormat:@"上午%@",rStr];
//    }else{
//    
//        if ([arr[0] integerValue] == 12){
//            [mStr appendFormat:@"下午%@",rStr];
//        }else{
//            if ([arr[0] integerValue]- 12 < 10) {
//                [mStr appendFormat:@"下午0%ld:%@",[arr[0] integerValue]- 12,arr[1]];
//            }else{
//                [mStr appendFormat:@"下午%ld:%@",[arr[0] integerValue]- 12,arr[1]];
//            }
//            
//        }
//        
...
//            self.titleArr = [NSArray arrayWithObjects:@[@"闹钟开关",@"标题"],@[@"闹钟定时",@"震动",@"铃声"],@[@"周期"],nil];


        }else{
            _titleArr = [NSMutableArray arrayWithObjects:@[LOCALIZED(@"闹钟开关")],@[LOCALIZED(@"闹钟定时"),LOCALIZED(@"震动")],@[LOCALIZED(@"周期")],nil];

//            _titleArr = [NSArray arrayWithObjects:@[@"闹钟开关"],@[@"闹钟定时",@"震动"],@[@"周期"],nil];
...
//    if (!lastOpenClock && !self.isOpenClock) {
//        
//    }else{
//        if (self.remindType == 0) {
//            
////            [HUDUtils showHUDToast:@"设置成功"];
//        }
//    }
}
